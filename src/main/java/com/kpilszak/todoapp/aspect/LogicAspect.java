package com.kpilszak.todoapp.aspect;
...
class LogicAspect {
	...
	LogicAspect(MeterRegistry registry) {
		projectCreateGroupTimer = registry.timer("logic.projet.create.group");
	}
	
	@Pointcut("execution(* com.kpilszak.todoapp.logic.ProjectService.createGroup(..))")
