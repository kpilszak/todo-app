...
import com.kpilszak.todoapp.model.*;
...
class ProjectServiceTest {
	...
	@Test
	@DisplayName("should throw IllegalArgumentException when configured to allow just 1 group and no groups no projects for a given id")
	...
	private static class InMemoryGroupRepository
			implements TaskGroupRepository {
		private int index = 0;
